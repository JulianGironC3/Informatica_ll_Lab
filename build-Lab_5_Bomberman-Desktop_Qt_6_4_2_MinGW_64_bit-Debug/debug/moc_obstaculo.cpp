...
#include <memory>
#include "../../Lab_5_Bomberman/obstaculo.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_obstaculo_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_obstaculo_t qt_meta_stringdata_obstaculo = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_obstaculo[] = {
...
Q_CONSTINIT const QMetaObject obstaculo::staticMetaObject = { {
    ...
    qt_meta_stringdata_obstaculo.offsetsAndSizes,
    qt_meta_data_obstaculo,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_obstaculo_t,
        // Q_OBJECT / Q_GADGET
