...
namespace {
struct qt_meta_stringdata_obstaculodes_t {
    uint offsetsAndSizes[2];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_obstaculodes_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_obstaculodes_t qt_meta_stringdata_obstaculodes = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_obstaculodes[] = {
...
Q_CONSTINIT const QMetaObject obstaculodes::staticMetaObject = { {
    ...
    qt_meta_stringdata_obstaculodes.offsetsAndSizes,
    qt_meta_data_obstaculodes,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_obstaculodes_t,
        // Q_OBJECT / Q_GADGET
...
void *obstaculodes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_obstaculodes.stringdata0))
